...
[test_example.cpp](https://www.github.com/JCash/jctest/examples/test_example.cpp) :
```C++
...
![test_example.png](https://www.github.com/JCash/jctest/examples/test_example.png)
